...
module.exports = function (_Generator) {
  ...
  _createClass(_class, [{
    ...
    value: function prompting() {
      ...
      this.log(_chalk2.default.bold.underline('Creating a React Component') + '\u2026');
    ...
    value: function writing() {
      ...
      this.fs.copyTpl(this.templatePath('_Component.js'), this.destinationPath(this.componentName + '.js'), this);
    }
  }, {
    key: 'end',
    value: function end() {

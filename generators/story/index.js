...
module.exports = function (_Generator) {
  ...
  _createClass(_class, [{
    ...
    value: function prompting() {
      ...
      this.log(_chalk2.default.bold.underline('Creating a story file') + '\u2026');
    ...
    value: function _createTemplateVars() {
      ...
      this.lowerComponentName = this.componentName.slice(0, 1).toLowerCase() + this.componentName.slice(1);
    }
  }, {
    key: 'writing',
    value: function writing() {
      this._createTemplateVars();
      this.fs.copyTpl(this.templatePath('_Component.story.js'), this.destinationPath(this.componentName + '.story.js'), this);
    }
  }, {
    key: 'end',
    value: function end() {

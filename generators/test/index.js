...
module.exports = function (_Generator) {
  ...
  _createClass(_class, [{
    ...
    value: function prompting() {
      ...
      this.log(_chalk2.default.bold.underline('Creating a Test file') + '\u2026');
    ...
    value: function writing() {
      ...
      this.fs.copyTpl(this.templatePath('_Component.test.js'), this.destinationPath(this.componentName + '.test.js'), this);
    }
  }, {
    key: 'end',
    value: function end() {
